# -*- coding: utf-8 -*-
#
# nxstaurusgui documentation build configuration file, created by
...
htmlhelp_basename = 'nxstaurusguidoc'
...
latex_documents = [
  ('index', 'nxstaurusgui.tex', u'nxstaurusgui Documentation',
   u'Author', 'manual'),
]
...
texinfo_documents = [
  ('index', 'nxstaurusgui', u'nxstaurusgui Documentation',
   u'Author', 'nxstaurusgui', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'http://www.esrf.fr/computing/cs/tango/tango_doc/'
    'kernel_doc/pytango/latest/': None,
}
